...
const birthday = new Date("2026-04-10 00:00:00").getTime();
...
========================= */
const text =
  "I dont know ki kaisa bna hai site but countdown 0 hit hone waqt rehna yahaa haa :) i dont know hamlog ka baat hoga ya nhi tab tak isiliye abhi hi bna diye. Aur ye kisiko bhejna nhi Ha :) btw neeche speaker icon ko press karke gaana sun sakti hai jab bhi site kholegi aur tap karegi uspe naya gaana bajega ";
let textIndex = 0;
function typeWriter() {
